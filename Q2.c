...
int main(void)
{
    ...
    P1->DIR = ~(uint8_t) BIT4;              // setting pin1.1 as input
    P1->OUT = BIT4;                         // pin is pulled up  ??
    P1->REN = BIT4;                         // enable input with pull up resistor// Enable pull-up resistor (P1.1 output high)
